...
export default function StockAdjustPage() {
  ...
  const displaySku =
    form.medicineMode === "existing"
      ? selectedMedicine?.sku || text.autoGeneratedOnSave
      : form.sku || text.autoGeneratedOnSave;
  const displayBatchNumber = form.batchNumber || text.autoGeneratedOnSave;
              ...
              >
                ...
                >
                  ...
                  <p className="mt-1 text-xs text-white/70">
                    {text.sku} {displaySku} • {text.batch} {displayBatchNumber}
                  </p>
                  <p className="mt-1 text-xs text-white/70">
                    {text.expiry} {form.expiryDate || text.notAvailable}
                  </p>
                </div>
              </div>
...
const STOCK_IN_COPY = {
  en: {
    ...
    skuAutoHint: "Leave blank to auto-generate a unique SKU for this pharmacy.",
    batchDetails: "Batch Details",
    batchNumber: "Batch Number",
    placeholderBatchNumber: "BN-44291-X",
    batchAutoHint:
      "Leave blank to auto-generate a unique batch number for this medicine in the branch.",
  ...
  am: {
    ...
    sku: "SKU",
    placeholderSku: "MED-001",
    skuAutoHint: "ባዶ ቢተዉት ለዚህ ፋርማሲ ልዩ SKU በራስ-ሰር ይፈጠራል።",
    batchDetails: "የባች ዝርዝሮች",
    batchNumber: "የባች ቁጥር",
    placeholderBatchNumber: "BN-44291-X",
    batchAutoHint:
      "ባዶ ቢተዉት ለዚህ መድሃኒት በቅርንጫፉ ውስጥ ልዩ የባች ቁጥር በራስ-ሰር ይፈጠራል።",
    ...
    expiry: "ማብቂያ",
    notAvailable: "—",
    autoGeneratedOnSave: "በማስቀመጥ ጊዜ በራስ-ሰር ይፈጠራል",
  ...
  om: {
    ...
    sku: "SKU",
    placeholderSku: "MED-001",
    skuAutoHint: "Duwwaa yoo dhiifte, SKU addaa farmasii kanaaf ofumaan ni uumama.",
    batchDetails: "Odeeffannoo Baachii",
    batchNumber: "Lakkoofsa baachii",
    placeholderBatchNumber: "BN-44291-X",
    batchAutoHint:
      "Duwwaa yoo dhiifte, lakkoofsi baachii addaa qoricha kanaaf damee keessatti ofumaan ni uumama.",
    ...
    expiry: "Xumuramuu",
    notAvailable: "—",
    autoGeneratedOnSave: "yeroo olkaa'an ofumaan ni uumama",
